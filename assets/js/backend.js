function jSelectElement(field1,field2,id){
	...
	if(selectedElements.indexOf(parseInt(id))<0){
		...
		let html='<li class="bd_element" id="element_'+id+'"><span class="element_name">'+field1+'</span><span class="element_type">'+field2+'</span><span class="element_id">'+id+'</span><input type="hidden" name="custom_id[]" value="'+id+'"/>';
